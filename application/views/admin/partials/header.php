...
<html lang="fr">
  <head>
    ...
    <title>Tableau de bord panel Admin</title>
    <!-- plugins:css -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/assets/vendors/iconfonts/mdi/css/materialdesignicons.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/assets/vendors/iconfonts/ionicons/css/ionicons.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/assets/vendors/iconfonts/typicons/src/font/typicons.css">
    ...
    <!-- inject:css -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/assets/css/shared/style.css">
    <!-- endinject -->
    <!-- Layout styles -->
