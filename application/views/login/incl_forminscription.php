            ...
            <div class="encadre-inscription">
                <div class="col centrage-col2">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label for="InsclientAdresse">Adresse :</label><input class="form-control" type="text"
                                                                                  ...
                                                                                  id="InsclientAdresse"
                                                                                  placeholder="25, rue Charles de Gaulle - Bâtiment E - Apt 106"
                                                                                  required>
                        ...
                        <div class="col-6">
                                <span id="hideInsclientSiret" style="display:none;"><label
                                            for="InsclientSiret">SIRET :</label><input class="form-control" type="text"
                                                                                       name="InsclientSiret"
                                                                                       id="InsclientSiret"
                                                                                       placeholder="732 829 320 00074"></span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <label for="InsclientPassV">Valdiation du mot de passe :</label><input
                                    class="form-control" type="password" name="InsclientPassV" id="InsclientPassV"
                                    required>
