<?php if($_SESSION["user_id"] == $dataCommande[0]->commande_client_id) // Permet de s'assurer que l'ID de l'utilisateur est bien celle du client de la commande, sinon le redirige
{ ?>
