                ...
                <nav>
                    <section class="nav-fostrap">
                        ...
                        <ul class="ligne_one">
                            ...
                            <!-- Panier -->
                            <li><a class="padding_ligne_one" href="<?= site_url('panier/index') ?>"><i class="fas fa-shopping-basket panier"><?php if(!empty($this->session->qte)){echo $this->session->qte; }?></i></a></li>
