        ...
        <section id="main">
            <nav>
                <section class="nav-fostrap">
                    ...
                    <ul class="ligne_one">
                        ...
                        <li>
                            <form class="form-inline md-form mr-auto">
                                <input class="form-control mr-sm-2 recherche" type="text" placeholder="What are you looking for?" aria-label="Search">
                        ...
                        <?php if (isset($_SESSION["grade"]) && isset($_SESSION["mail"])) { ?>
                            <li class="padding_ligne_one"><a href="">Logged<span class="arrow-down"></span></a>
                                <ul class="dropdown">
                                    <li class="esp_client"><a class="dropdown-item" href="<?= site_url('index.php/welcome/modifcompte') ?>"><i class="fas fa-id-card"></i> My account</a></li>
                                    <li class="esp_client"><a class="dropdown-item" href="<?= site_url('index.php/welcome/deconnexion') ?>"><i class="fa fa-sign-out"></i> Sign Out</a></li>
                                </ul>
                            </li>
                        <?php } else { ?>
                            <li class="padding_ligne_one"><a href="">Client Area<span class="arrow-down"></span></a>
                                <ul class="dropdown">
                                    <li class="esp_client"><a class="dropdown-item" href="<?= site_url('index.php/welcome/connexion') ?>"><i class="fas fa-sign-in-alt"></i> Log in</a></li>
                        ...
                        <!-- Langue -->
                        <li class="padding_ligne_one">
                            <a href=""><span class="flag-icon flag-icon-gb"> </span> English<span class="arrow-down"></span></a>
                            <ul class="dropdown">
                                <li class="choixdrap"><a class="dropdown-item" href=""><span class="flag-icon flag-icon-fr"> </span> Français</a></li>
                    ...
                    <!-- NavBar Ligne 2-->
                    <ul class="ligne_two">
                        <li><a href="<?= site_url('index.php/welcome/index') ?>">Home</a></li>
                        <li><a href="">Products</a></li>
                        <li><a href="">Help</a></li>
                        <li><a href="<?= site_url('index.php/welcome/apropos') ?>">About</a></li>
                    </ul>
